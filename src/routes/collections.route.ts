...
import {
  ...
  deleteBookFromCollectionSchema,
  newCollectionSchema,
...
import {
  ...
  getAllCollections,
  getCollection,
} from "../controllers/collections.controler";
...
collections.post(
  "",
  verifyShape(newCollectionSchema),
  checkToken,
  createCollection
);
...
collections.post(
  "/:id/books",
  verifyShape(addBookToCollectionSchema),
  checkToken,
  checkCollection,
  checkBook,
  addBook
...
collections.delete(
  "/:id/books/:bookId",
  verifyShape(deleteBookFromCollectionSchema),
  checkToken,
  checkCollection,
