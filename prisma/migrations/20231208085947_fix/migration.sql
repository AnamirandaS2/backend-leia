/*
  ...
  - Added the required column `page` to the `Activity` table without a default value. This is not possible if the table is not empty.
...
ADD CONSTRAINT "Activity_pkey" PRIMARY KEY ("userId", "bookId");
